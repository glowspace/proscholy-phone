...
// ----------
// temporarily copied AppBar implementation, so we can setup statusbar color
// ----------
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: AnnotatedRegion<SystemUiOverlayStyle>(
        value: overlayStyle.copyWith(statusBarColor: widget.backgroundColor ?? appBarTheme.color ?? theme.primaryColor),
        child: Material(
