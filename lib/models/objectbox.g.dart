...
final _entities = <ModelEntity>[
  ...
  ModelEntity(
      ...
      backlinks: <ModelBacklink>[]),
  ModelEntity(
      id: const IdUid(5, 5722656750256100534),
      name: 'SongLyric',
      lastPropertyId: const IdUid(9, 7671315634081304656),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 809050937703252492),
            name: 'id',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 4774006349046573734),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 329289963093354246),
            name: 'secondaryName1',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 1689786811235179787),
            name: 'secondaryName2',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 6671414168712327567),
            name: 'lyrics',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(6, 638797381657980389),
            name: 'lilypond',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(7, 2411306619182484870),
            name: 'lang',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(8, 1231181773716438848),
            name: 'langDescription',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(9, 7671315634081304656),
            name: 'songId',
            type: 11,
            flags: 520,
            indexId: const IdUid(2, 2716802364401716736),
            relationTarget: 'Song')
      ],
      relations: <ModelRelation>[
        ModelRelation(
            id: const IdUid(3, 8108467477343318656),
            name: 'tags',
            targetId: const IdUid(4, 6296825599350518621)),
        ModelRelation(
            id: const IdUid(4, 2172473142352873193),
            name: 'authors',
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(10, 3974850738104585390),
      lastIndexId: const IdUid(5, 2362390301723731104),
      lastRelationId: const IdUid(5, 908885689419134235),
      lastSequenceId: const IdUid(0, 0),
      retiredEntityUids: const [6628950258912287707, 3997966892313177785],
  ...
  final bindings = <Type, EntityDefinition>{
    ...
    SongLyric: EntityDefinition<SongLyric>(
        ...
        toManyRelations: (SongLyric object) => {
              RelInfo<SongLyric>.toMany(3, object.id): object.tags,
              RelInfo<SongLyric>.toMany(4, object.id): object.authors,
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          InternalToManyAccess.setRelInfo(object.tags, store,
              RelInfo<SongLyric>.toMany(3, object.id), store.box<SongLyric>());
          InternalToManyAccess.setRelInfo(object.authors, store,
              RelInfo<SongLyric>.toMany(4, object.id), store.box<SongLyric>());
...
class SongLyric_ {
  /// see [SongLyric.id]
  static final id = QueryIntegerProperty<SongLyric>(_entities[2].properties[0]);

  /// see [SongLyric.name]
  static final name =
      QueryStringProperty<SongLyric>(_entities[2].properties[1]);

  /// see [SongLyric.secondaryName1]
  static final secondaryName1 =
      QueryStringProperty<SongLyric>(_entities[2].properties[2]);

  /// see [SongLyric.secondaryName2]
  static final secondaryName2 =
      QueryStringProperty<SongLyric>(_entities[2].properties[3]);

  /// see [SongLyric.lyrics]
  static final lyrics =
      QueryStringProperty<SongLyric>(_entities[2].properties[4]);

  /// see [SongLyric.lilypond]
  static final lilypond =
      QueryStringProperty<SongLyric>(_entities[2].properties[5]);

  /// see [SongLyric.lang]
  static final lang =
      QueryStringProperty<SongLyric>(_entities[2].properties[6]);

  /// see [SongLyric.langDescription]
  static final langDescription =
      QueryStringProperty<SongLyric>(_entities[2].properties[7]);

  /// see [SongLyric.song]
  static final song =
      QueryRelationToOne<SongLyric, Song>(_entities[2].properties[8]);

  /// see [SongLyric.tags]
  static final tags =
      QueryRelationToMany<SongLyric, Tag>(_entities[2].relations[0]);

  /// see [SongLyric.authors]
  static final authors =
      QueryRelationToMany<SongLyric, Author>(_entities[2].relations[1]);
}

/// [Song] entity fields to define ObjectBox queries.
class Song_ {
  /// see [Song.id]
  static final id = QueryIntegerProperty<Song>(_entities[3].properties[0]);

  /// see [Song.name]
  static final name = QueryStringProperty<Song>(_entities[3].properties[1]);
}

/// [Author] entity fields to define ObjectBox queries.
class Author_ {
  /// see [Author.id]
  static final id = QueryIntegerProperty<Author>(_entities[4].properties[0]);

  /// see [Author.name]
  static final name = QueryStringProperty<Author>(_entities[4].properties[1]);
}

/// [Songbook] entity fields to define ObjectBox queries.
class Songbook_ {
  /// see [Songbook.id]
  static final id = QueryIntegerProperty<Songbook>(_entities[5].properties[0]);

  /// see [Songbook.name]
  static final name = QueryStringProperty<Songbook>(_entities[5].properties[1]);

  /// see [Songbook.shortcut]
  static final shortcut =
      QueryStringProperty<Songbook>(_entities[5].properties[2]);

  /// see [Songbook.color]
  static final color =
      QueryStringProperty<Songbook>(_entities[5].properties[3]);

  /// see [Songbook.colorText]
  static final colorText =
      QueryStringProperty<Songbook>(_entities[5].properties[4]);

  /// see [Songbook.isPrivate]
  static final isPrivate =
      QueryBooleanProperty<Songbook>(_entities[5].properties[5]);
}
...
class SongbookRecord_ {
  ...
  static final id =
      QueryIntegerProperty<SongbookRecord>(_entities[6].properties[0]);

  /// see [SongbookRecord.songLyric]
  static final songLyric =
      QueryRelationToOne<SongbookRecord, SongLyric>(_entities[6].properties[1]);

  /// see [SongbookRecord.songbook]
  static final songbook =
      QueryRelationToOne<SongbookRecord, Songbook>(_entities[6].properties[2]);

  /// see [SongbookRecord.number]
  static final number =
      QueryStringProperty<SongbookRecord>(_entities[6].properties[3]);
}
...
class External_ {
  ...
  /// see [External.name]
  static final name = QueryStringProperty<External>(_entities[7].properties[1]);
  ...
  static final songLyric =
      QueryRelationToOne<External, SongLyric>(_entities[7].properties[3]);
}
